...
#include <lslidar_msgs/Lslidar128S1Packet.h>
#include <string>
#include <sstream>
 ...
 */
    ...
    public:
        ...
        virtual int getPacket(lslidar_msgs::Lslidar128S1PacketPtr &packet) = 0;
...
/** @brief Live lslidar input from socket. */
    ...
    public:
        ...
        virtual int getPacket(lslidar_msgs::Lslidar128S1PacketPtr &packet);
